; #Info# ======================================================================================================================
; Title .........: pseudoMinerFlBajio
; Version .......: U
; AutoIt Version : 3.3.14.2
; Language ......: English
; Description ...: Extract information and classify it from GenBank for each species reported for Bajio Flora, using Entrez API
...
$oFileSp = "ListOfSpecies.txt" ;<== File name (file formated Genus+species one species per line)
$fResultFile = "Result.csv" ;<== Define output file name
...
;$aE[3] = "//GBSet/GBSeq/GBSeq_definition"
;$aE[4] = "//GBSet/GBSeq/GBSeq_feature-table/GBFeature/GBFeature_quals/GBQualifier/GBQualifier_value" ; Deleted due last modification of entrez return translation of nt
...
Local $aS[6] ; <== Define number searches
